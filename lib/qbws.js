...
var qbws,
    ...
    companyFile = process.env.QB_COMPANY_FILE || 'C:\\Users\\Public\\Documents\\Intuit\\QuickBooks\\Sample Company Files\\QuickBooks 2014\\sample_wholesale-distribution business.qbw',
    req = [],
    config = {
        'verbosity': 2
    };
 ...
 */
qbws.QBWebConnectorSvc.QBWebConnectorSvcSoap.serverVersion = function (args, callback) {
    var retVal = '0.2.1';
