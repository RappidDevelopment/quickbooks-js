 ...
 * @type {string}
 */
var username = process.env.QB_USERNAME || 'test';
...
webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.sendRequestXML = function(args, callback) {
    // Instead of using an array here, use something like a stack or queue
    // Each time a request is made, pop off the item 
    // Then watch it from the response. If its successful, discard it from the main storage. 
    // 
    var request = '';
